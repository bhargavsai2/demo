...
$(document).ready(function() {
  function croche_masonry($masonry)
  {
  ...
  $('.croche-masonry').each(function () { 
    ...
    $('.masonry_fillter .item-fillter').on( 'click', function() {
      ...
      $(this).closest('.croche-masonry').find('.masonry_fillter .item-fillter').removeClass('fillter-active');
